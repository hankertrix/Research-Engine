...
This web application is licensed under the GNU AGPL v3 license. For the full license, look at the [LICENSE.txt](https://github.com/hankertrix/Research-Engine/blob/main/LICENSE.txt) file.
