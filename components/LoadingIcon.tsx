...
const LoadingIcon: NextPage<{width?: number | string, height?: number | string}> = ({ width, height }) => {
  ...
  return (
    <>
      <svg className={`${themeClass(styles, "icon")} ${styles.icon}`} style={{width: width ? width : "100%", height: height ? height : "auto"}} width="120" height="160" viewBox="0 0 120 160" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g id="Research Icon" clip-path="url(#clip0_1_12)">
          ...
          <g id="Subtract">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M67 144H33L40.0436 125H59.9565L67 144Z" fill="white" />
          ...
          <g className={styles.scope}>
            <rect id="piston" x="64.0881" y="18.0634" width="15" height="9" transform="rotate(30 64.0881 18.0634)" fill="white" stroke="black" stroke-width="3" stroke-linejoin="round" />
            <rect id="Rectangle 4" x="54.3919" y="22.8576" width="27" height="42" transform="rotate(30 54.3919 22.8576)" fill="white" stroke="black" stroke-width="3" stroke-linejoin="round" />
            <rect id="Rectangle 8" x="29.0618" y="56.7307" width="37" height="9" transform="rotate(30 29.0618 56.7307)" fill="white" stroke="black" stroke-width="3" stroke-linejoin="round" />
            <rect id="Rectangle 5" x="64.624" y="9.13516" width="23" height="8" transform="rotate(30 64.624 9.13516)" fill="white" stroke="black" stroke-width="3" stroke-linejoin="round" />
            <circle id="joint" cx="70.7746" cy="48.4819" r="7" transform="rotate(30 70.7746 48.4819)" fill="white" stroke="black" stroke-width="3" />
            <g className={`${styles["lens3-1"]} ${styles.lens3}`}>
              <path id="len3" d="M34.0247 69.9892L28.0321 66.5285L13.7032 74.7905C12.7458 75.3426 12.4176 76.5667 12.9705 77.5237L13.9722 79.2575C14.5246 80.2137 15.7475 80.5412 16.7039 79.989L34.0247 69.9892Z" fill="white" stroke="black" stroke-width="3" stroke-linejoin="round" />
            ...
            <g className={styles.lens2}>
              <path id="len2" d="M37.9852 72.2748L43.1814 75.2748L33.1814 92.5954C32.6291 93.5519 31.4059 93.8797 30.4493 93.3274L28.7173 92.3274C27.7607 91.7751 27.4329 90.5519 27.9852 89.5954L37.9852 72.2748Z" fill="white" stroke="black" stroke-width="3" stroke-linejoin="round" />
              <path className={styles.marker} d="M28.1424 86.3375L35.928 90.8325" stroke="black" />
            </g>
            <g className={`${styles["lens1-1"]} ${styles.lens1}`}>
              <path id="len1" d="M47.1474 77.5656L53.1407 81.0249L53.15 97.5652C53.1506 98.6704 52.2547 99.5666 51.1494 99.5663L49.1471 99.5657C48.0428 99.5654 47.1477 98.6701 47.1477 97.5657L47.1474 77.5656Z" fill="white" stroke="black" stroke-width="3" stroke-linejoin="round" />
